        ...
        <br>
             <div class="transbox">
                ...
                <span class="error">*<?php echo $name_err; ?></span>
                 ...
                 <span id="messages" style="color:blue;" ></span>
             </div>
<br>
             <div class="transbox">
...
<br>            
             <div class="transbox">
                ...
                <input type="password" id="cpassword" name="confirm_password" class="form-control <?php echo (!empty($confirm_password_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $confirm_password; ?>">
                <span class="error">*<?php echo $confirm_password_err; ?></span>
                 <span id="messages4" style="color:orange;" ></span>
             </div>
              </from>
      </fieldset>
...
<script>
  ...
  if(name == ""){
 	document.getElementById("messages").innerHTML ="** please fill the   name";
 	return false;
 	...
 	document.getElementById("messages4").innerHTML ="** please fill the confirm password";
 	return false;
