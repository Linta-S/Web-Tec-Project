...
<body style="background-image: url(pic13.jpeg); background-size: cover;">
    ...
    <center>
     ...
     <h1><div class="transparent-box">Hi Admin, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>.This is our Seller page.</div></h1>  

 
 
 <div class="btn-group">
        <a href="sellers.php" class="button">Sellers Profile</a>
     
       <a href="sell-transaction.php" class="button">Transatction Details </a>
        <a href="Mseller.php" class="button"> Mannage seller  </a>
