...
<body style="background-image: url(pic13.jpeg); background-size: cover;">
 ...
 <div class="btn-group">
        <a href="customers.php" class="button">Customers Profile</a>
     
       <a href="customers-transaction.php" class="button">Transatction Details </a>
  
       <a href="Mcustomer.php" class="button"> Mannage Customer</ </a>
